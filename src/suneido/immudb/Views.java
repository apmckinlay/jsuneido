...
class Views {
	...
	static void addView(ImmuUpdateTran t, String name, String definition) {
	...
	static String getView(ImmuReadTran t, String name) {
	...
	static boolean dropView(ImmuUpdateTran t, String name) {
	...
	private static Record getViewRecord(ImmuReadTran t, String name) {
