 ...
 * Inherits method handling from {@link BuiltinMethods2}.
 ...
 */
public abstract class BuiltinClass2 extends BuiltinMethods2 {

	protected BuiltinClass2() {
	}

	protected BuiltinClass2(Class<?> c) {
		super(c);
	}
	protected BuiltinClass2(Class<?> c, String name) {
		super(c, name);
	}
