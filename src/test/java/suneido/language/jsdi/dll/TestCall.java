...
public enum TestCall {
	...
	INT8("TestChar", Mask.INT8, PrimitiveSize.INT8),
	INT16("TestShort", Mask.INT16, PrimitiveSize.INT16),
	INT32("TestLong", Mask.INT32, PrimitiveSize.INT32),
	...
	REMOVE_SIGN_FROM_INT32("TestRemoveSignFromLong", Mask.INT64,
			PrimitiveSize.INT32),
	SUM_TWO_INT8("TestSumTwoChars", Mask.INT8,
			PrimitiveSize.INT8, PrimitiveSize.INT8),
	SUM_TWO_INT16("TestSumTwoShorts", Mask.INT16,
			PrimitiveSize.INT16, PrimitiveSize.INT16),
	SUM_TWO_INT32("TestSumTwoLongs", Mask.INT32,
	...
	SUM_THREE_INT32("TestSumThreeLongs", Mask.INT32,
			PrimitiveSize.INT32, PrimitiveSize.INT32, PrimitiveSize.INT32),
	SUM_FOUR_INT32("TestSumFourLongs", Mask.INT32,
			PrimitiveSize.INT32, PrimitiveSize.INT32, PrimitiveSize.INT32,
			PrimitiveSize.INT32),
	SUM_INT8_PLUS_INT64("TestSumCharPlusInt64", Mask.INT64,
			PrimitiveSize.INT8, PrimitiveSize.INT64),
	SUM_PACKED_INT8_INT8_INT16_INT32("TestSumPackedCharCharShortLong", Mask.INT32,
